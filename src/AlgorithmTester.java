...
public class AlgorithmTester { 
    ...
    private void runTestAndWriteToCSV(String fileName, int startIndex) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("src/Puzzles/test_results.csv", true))) {
            ...
            for (int i = startIndex; i < gen.getFileLength(fileName); i++) {
                PuzzleBoard currBoard = gen.readFile(fileName, i);
    ...
    // Main method to run the algorithm tester
    public void testAlgorithmRealTime(String fileName, int startIndex) {

        runTestAndWriteToCSV(fileName, startIndex);
